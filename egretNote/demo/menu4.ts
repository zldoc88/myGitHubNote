class menu4 extends  egret.Sprite{

    public static CLASSNAME: string = "menu4";
    ...
    public  initStart(){
        ...
        //线
        var icon1:egret.Texture = RES.getRes( "menu4_icon_1_png" );
        this.icon1= new egret.Bitmap( icon1 );
        this.addChild(this.icon1);
        this.icon1.x=32;
        this.icon1.y=100;

        this.configTES=Game.CONFIG['menu4'];

        // menu1_icon_2_png 主播头像 旋转
        this.icon2=new egret.Sprite();

        var icon2:egret.Texture = RES.getRes( "menu4_icon_2_png" );
        ...
        var icon3:egret.Texture = RES.getRes( "menu4_icon_3_png" );
        ...
        var icon4:egret.Texture = RES.getRes( "menu4_icon_4_png" );
        ...
        // 人物、月球
        var pic1:egret.Texture = RES.getRes( "menu4_pic_1_png" );
        ...
        // 太阳
        var pic2:egret.Texture = RES.getRes( "main_menu_pic_png" );
    ...
    private upDataItemInfo(sp ,data,isnull){
        ...
        this[isnull].name.textColor  = '0x8c55b7';
        ...
        this[isnull].age.textColor  = '0x8c55b7';
    ...
    private  changStatue(e){
        ...
        pic1TW.to({y:155},750).call(()=>{
            ...
            this.DrawContainer.renwu.y=155;
