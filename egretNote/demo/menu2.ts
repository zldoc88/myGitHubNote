class menu2 extends  egret.Sprite{

    public static CLASSNAME: string = "menu2";
    ...
    public  initStart(){
        ...
        //线
        var icon1:egret.Texture = RES.getRes( "menu2_icon_1_png" );
        this.icon1= new egret.Bitmap( icon1 );
        this.addChild(this.icon1);
        this.icon1.x=32;
        this.icon1.y=100;

        this.configTES=Game.CONFIG['menu2'];

        // menu1_icon_2_png 主播头像 旋转
        this.icon2=new egret.Sprite();

        var icon2:egret.Texture = RES.getRes( "menu2_icon_2_png" );
        ...
        var icon3:egret.Texture = RES.getRes( "menu2_icon_3_png" );
        ...
        var icon4:egret.Texture = RES.getRes( "menu2_icon_4_png" );
        ...
        // 人物、月球
        var pic1:egret.Texture = RES.getRes( "menu2_pic_1_png" );
    ...
    private upDataItemInfo(sp ,data,isnull){
        ...
        this[isnull].name.textColor  = '0x82a030';
        ...
        this[isnull].age.textColor  = '0x82a030';
