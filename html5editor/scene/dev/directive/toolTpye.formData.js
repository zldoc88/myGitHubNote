define(['angularAMD'],function(angularAMD){
    angularAMD.directive('drawFormdata', ['$document','$compile',function($document,$compile) {
    ...
    angularAMD.controller('checkboxcontrl', ['$scope',function($scope) {
        $scope.checkedformAlign=function(keyname,val){
              $scope.$broadcast('checkboxLayoutItemCast',{keyname:keyname,val:val});
        };
    }]);
    angularAMD.directive('checkboxcontrlDir', ['$document','$compile',function($document,$compile){
        return {
            link:function(scope,element,attr){
    ...
    angularAMD.controller('inputlist', ['$scope',function($scope) {
        $scope.itemlist = [];
    ...
    angularAMD.directive('inputlist', ['$document','$compile',function($document,$compile) {
        return{
            link:function(scope,element,attr){
    ...
    angularAMD.directive('editerText', ['$document','$compile',function($document,$compile) {
        return {
    ...
    angularAMD.directive('editerRadio', ['$document','$compile',function($document,$compile) {
        return {
    ...
    angularAMD.directive('editerCheckbox', ['$document','$compile',function($document,$compile) {
        return {
    ...
    angularAMD.directive('editerSelect', ['$document','$compile',function($document,$compile) {
        return {
    ...
    angularAMD.directive('editerTextarea', ['$document','$compile',function($document,$compile) {
        return {
