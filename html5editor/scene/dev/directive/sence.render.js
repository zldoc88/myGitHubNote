define(['angularAMD'],function(angularAMD){
    angularAMD.directive('senceRender', ['$document','$compile',function($document,$compile) {
        return {
            link:function(scope,element,attr){
                ...
                element.on('click',function(e){
                    if(scope.ActiveToolType=='default' || scope.ActiveToolType=='pick' || scope.ActiveToolType=='editTexting') return;
