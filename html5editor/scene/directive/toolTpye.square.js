app.directive('drawSquare', ['$document','$compile',function($document,$compile) {

    return {
        link : function(scope,element,attr){
            var template = '<div class="fouce-region" move-component setting="{{square}}" ng-click="chooseComponent(square.type,square.id)" ></div>'+
...
app.directive('editerSquare', ['$document','$compile',function($document,$compile) {
    return {
