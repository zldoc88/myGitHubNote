var version = 'v1.0.1',loadState=0;
require.config({
    ...
    shim: {
        ...
        'ngSelect': ['angular','angularAMD'],
        'ngMenu': ['angular','angularAMD'],
        'ngAlert': ['angular','angularAMD'],
        'angular-animate': ['angular','angularAMD']
        ,'ng-animate': ['angular','angularAMD']
